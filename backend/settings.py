...
class _AzureSearchSettings(BaseSettings, DatasourcePayloadConstructor):
    ...
    index_1: str = Field(serialization_alias="index_name_1")
    index_2: str = Field(serialization_alias="index_name_2")
    index_3: str = Field(serialization_alias="index_name_3")
